import { defaultApplicantResources, defaultSpecializationGroups } from './constants'
import { revalidateSpecializationsPageSettings } from './hooks'
...
export const SpecializationsPageSettings: GlobalConfig = {
          ...
          fields: [
            {
              ...
              defaultValue: defaultSpecializationGroups,
              required: true,
              fields: [
                {
                  name: 'anchor',
                ...
                },
                {
                  name: 'specialtyCodes',
                  type: 'array',
                  label: 'Коди спеціальностей',
                  labels: {
                    singular: 'Код спеціальності',
                    plural: 'Коди спеціальностей',
                  },
                  required: true,
                  fields: [
                    {
          ...
          fields: [
            {
              ...
              defaultValue: defaultApplicantResources,
              minRows: 1,
              required: true,
              fields: [
                {
  ...
  hooks: {
    afterChange: [revalidateSpecializationsPageSettings],
  },
  versions: {
    drafts: {
      validate: false,
