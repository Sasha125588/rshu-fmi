				...
				<div className='flex items-start gap-6'>
					...
					<div className='flex-1'>
						...
						<p className='mb-4 text-lg leading-relaxed text-gray-600'>
							...
							двох факультетах стаціонарного відділення – фізико-математичному та
							мовно-літературному – розпочали навчання 179 студентів. Працювало тоді в інституті 17
							штатних викладачів.
						</p>
				...
				<div className='flex items-start gap-6'>
					...
					<div className='flex-1'>
						...
						<p className='mb-6 text-lg leading-relaxed text-gray-600'>
							...
							який розпочав підготовку фахівців у галузі математики, а згодом прикладної математики
							та інформатики на Рівненщині. Всі ВНЗ Рівненщини брали кадри із випускників нашого
							факультету.
						</p>
