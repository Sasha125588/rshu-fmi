...
import { LandingBackdrop } from '../sections/LandingBackground'
import { SPECIALIZATIONS_DATA } from '../Specializations/constants/data'
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
import type { NewsItem } from '../News/constants/types'
...
const allPrograms = SPECIALIZATIONS_DATA
...
export const HomePage = ({ news }: HomePageProps) => (
  <div>
        ...
        <div className="flex max-w-4xl flex-col items-start">
          ...
          <p className=" mt-5 max-w-2xl text-lg leading-relaxed font-medium md:text-xl">
            <span className="bg-background text-muted-foreground rounded-full box-decoration-clone px-3">
              Освітні програми, документи, новини та студентські сервіси факультету в одному місці.
              Швидкий старт для абітурієнтів і зручна навігація для студентів.
            </span>
          </p>
          ...
          <div className="mt-8 flex flex-col items-start gap-3 sm:flex-row">
            <Button
              render={
                <Link
                  href="#specializations"
                  className="group bg-foreground! text-background! hover:bg-foreground/80! h-11 justify-center gap-1 px-5 text-sm font-bold! tracking-tight"
                />
              }
            >
            ...
            <Button
              ...
              render={
                <Link
                  ...
                  className="h-11 justify-center gap-2 px-5 text-sm font-semibold tracking-tight"
                />
              }
            >
              <GraduationCapIcon
        ...
        <div className="mt-12">
          {reasons.map((reason, index) => (
            ...
            >
              ...
              <h3 className="text-2xl font-semibold tracking-tight md:text-3xl">{reason.title}</h3>
      ...
      <div>
        <div className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
          ...
          <Button
            variant="outline"
            size="lg"
            className="border-border hover:bg-foreground/7.5 text-foreground shrink-0 self-start bg-white/[0.035] md:self-auto"
            nativeButton={false}
            render={
              <Link
        ...
        <ul className="mt-10 ">
          {news.slice(0, 6).map((item, index, latestNews) => (
            ...
            >
              <span
                aria-hidden="true"
                className="bg-accent-violet absolute top-5 bottom-5 left-0 z-10 w-0.5 rounded-full opacity-0 transition-opacity duration-200 group-hover:opacity-100"
              />
