...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/educational-programs',
  },
  openGraph: {
    ...
    url: new URL('/educational-programs', SITE_URL).href,
    type: 'website',
    locale: 'uk_UA',
  },
}

const EducationalProgramsPage = async () => {
  const {
    ...
    specialties,
    tuitionRates,
  } = await loadEducationalProgramsPageData()

  const navigationGroups = configuredGroups.map(({ anchor, interestLabel }) => ({
    anchor,
    interestLabel,
  }))
        ...
        <section className="px-4 py-16 md:px-12 md:py-24">
          <Empty className="min-h-80 border">
            <EmptyHeader>
              ...
              <EmptyDescription>
                Каталог зʼявиться після публікації спеціальностей у CMS.
              </EmptyDescription>
            </EmptyHeader>
          </Empty>
        </section>
