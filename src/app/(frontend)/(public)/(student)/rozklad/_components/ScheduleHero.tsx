import { ScheduleSculpture } from './ScheduleBackground'
import { Typography } from '@/components/ui/typography'

import type { ReactNode } from 'react'

export const ScheduleHero = ({ sourceMeta }: { sourceMeta: ReactNode }) => (
  <header
    data-testid="schedule-shell"
    className="relative isolate flex min-h-80 items-center overflow-hidden border-b px-4 py-12 md:min-h-88 md:px-12 md:py-16"
  >
    <ScheduleSculpture />
