...
function NavigationMenu({
  ...
  Pick<NavigationMenuPrimitive.Positioner.Props, 'align' | 'collisionPadding'>) {
  return (
  ...
  return (
    <NavigationMenuPrimitive.Portal>
      <NavigationMenuPrimitive.Positioner
        ...
        {...props}
      >
        <NavigationMenuPrimitive.Popup className="data-[ending-style]:easing-[ease] xs:w-(--popup-width) bg-popover text-popover-foreground ring-foreground/5 relative h-(--popup-height) w-(--popup-width) origin-(--transform-origin) rounded-2xl shadow ring-1 transition-[opacity,transform,width,height,scale,translate] duration-[0.35s] ease-[cubic-bezier(0.16,1,0.3,1)] outline-none data-ending-style:scale-90 data-ending-style:opacity-0 data-ending-style:duration-300 data-ending-style:ease-[cubic-bezier(0.34,1.2,0.64,1)] data-starting-style:scale-90 data-starting-style:opacity-0">
